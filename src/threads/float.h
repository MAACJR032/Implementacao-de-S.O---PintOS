...
#define FLOAT_DIV_MIX(A,B) (A / B) //1 float E 1 int

#define FLOAT_MULT(A,B) ((float_type)(((int64_t) A) * B >> FLOAT_SHIFT_AMOUNT)) //2 float 

#define FLOAT_DIV(A,B) ((float_type)((((int64_t) A) << FLOAT_SHIFT_AMOUNT) / B)) //2 float 
